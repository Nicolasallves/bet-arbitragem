...
##  busca o cod html para as odds baseado na data e type
    web_url = dict()
    web_url['ML'] = ''
...
## Parse HTML
    def book_line(book_id, line_id, homeaway):
        ## info da linha que vem do book id
    ...
    for i in range(0, number_of_games):
        A = []
        H = []
        ## busca linha/odds do book unico, Precisa de manipulação de erros para contabilizar dados em branco
        ...
        ## dados de A e H (listas) para efetuar o put no DataFrame
